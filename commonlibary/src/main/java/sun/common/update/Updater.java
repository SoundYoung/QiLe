...
public class Updater {
    ...
    public void download(UpdaterConfig updaterConfig,String appname) {
        ...
        if (downloadId != -1L) {
            ...
            switch (status) {
                ...
                case DownloadManager.STATUS_SUCCESSFUL:
                    ...
                    //重新下载
                    startDownload(updaterConfig, appname);
                    break;
                //下载失败
    ...
    private void startDownload(UpdaterConfig updaterConfig,String appname) {
        long id = FileDownloadManager.get().startDownload(updaterConfig,appname);
